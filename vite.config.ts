...
function stubServerModulesForCypress(): Plugin {
  const stubs: Record<string, string> = {
    ...
    [resolve(__dirname, './app/server/infra/env.server.ts')]: `
    ...
    [resolve(__dirname, './app/modules/auth/select.server.ts')]: `
    ...
    [resolve(__dirname, './app/modules/auth/session/cookie.ts')]: `
    ...
    [resolve(__dirname, './app/server/observability.ts')]: `
    ...
    [resolve(__dirname, './app/resources/webauthn/webauthn-verify.ts')]: `
      import { z } from 'zod';
    ...
    [resolve(__dirname, './app/modules/auth/session/reauth-intent.ts')]: `
    ...
    [resolve(__dirname, './app/server/auth-context.server.ts')]: `
    ...
    [resolve(__dirname, './app/server/csrf.ts')]: `
    ...
    [resolve(__dirname, './app/modules/auth/providers/zitadel/transport.ts')]: `
