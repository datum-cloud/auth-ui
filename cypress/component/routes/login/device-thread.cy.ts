...
// /login?requestId=device_<userCode>. The identifier action must accept and thread the
// device_ requestId (real bug found against Zitadel: old schemas allowed only /^oidc_/).
