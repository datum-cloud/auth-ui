// Compile-time type-narrowing assertions for the IdP method return types.
//
...
//   real: 'bun run typecheck' fails before the interface is tightened, passes after.
//
...
describe('AuthProvider IdP method types', () => {
  it('compile-time gates above enforce non-unknown return types — see file header', () => {
    ...
    // compile — that was the failing state before the interface was tightened.
  });
});
