// Pass 2 service test (migrated from routes/authorize/__tests__/device.test.ts).
//
...
//
// The device branch is now in resolveAuthorize; we drive the service and translate the
// outcome to a Response (identical to the old route loader) to preserve every assertion.
